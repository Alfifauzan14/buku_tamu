  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      <form method="post" action="" enctype="multipart/form-data">
        ...
        <div class="form-group row">
          <label for="bertamu" class="col-sm-3 col-form-label">bertamu dg.</label>
          <div class="col-sm-8">
            <input type="text" class="form-control" id="bertamu" name="bertamu" value="<?= $data['bertamu'] ?>">
          </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
          <label for="" class="col-sm3 col-form-label"></label>
